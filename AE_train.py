...
def get_arguments():
    ...
    parser.add_argument('--center', type=str, default='GUIDE',
                        choices=['GUIDE', 'VISION', 'two', 'GUIDE1', 'GUIDE2', 'TW'])
    parser.add_argument('--n_splits', type=int, default=1, help="Test split")
    ...
    parser.add_argument('--entropy', type=int, default=0, help="Add entropy and other parameters")
    ...
    args.resume = "/home/zhuo/Desktop/CRT_autoencoder/results/1023_pm0510_2types_1fold/32_RS1/training_systolicPhase/BEST_checkpoint.ckpt"

    # Review delong results
    args.entropy = 1
    args.results_path = "/home/zhuo/Desktop/CRT_autoencoder/results/1023_pm0510_2types_1fold/32_RS1/infer_train_systolicPhase_review_addParams"
    args.image_path = "/home/zhuo/Desktop/CRT_autoencoder/data/{}/train_GUIDEtwo_3type".format(args.image_type)

    # VISION
    # args.center = 'VISION'
    # args.response_source = 'SPECT'
    # args.results_path = "/home/zhuo/Desktop/CRT_autoencoder/results/1023_pm0510_2types_1fold/32_RS1/infer_VISION_systolicPhase"
    # args.image_path = "/home/zhuo/Desktop/CRT_autoencoder/data/phase/train/VISION"
    # args.clinic_path = "/home/zhuo/Desktop/CRT_autoencoder/data/1.6_ML.csv"

    # TW
    # args.center = "TW"
    # args.results_path = "/home/zhuo/Desktop/CRT_autoencoder/results/1023_pm0510_2types_1fold/32_RS1/infer_TW_systolicPhase"
    # args.image_path = "/home/zhuo/Desktop/CRT_autoencoder/data/phase/train/TW"
