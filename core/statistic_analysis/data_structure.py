...
def label_crt_response(df, response_definer, response_source, label_name='Response', dropna=True):
    """ Label CRT response
    ...
    df[label_name] = df.apply(lambda row: label_one_row(row, pre_LVEF, post_LVEF, response_definer,
