...
from core.statistic_analysis import center_filter, label_crt_response, crt_criteria, set_columns, data_structure, \
    preprocessing_AEfeatures, univariate_analysis, pearson_corr, multivariate_analysis
...
class AEtrainer(object):
    ...
    def evaluate_result(self, results, multi):
        ...
        clinic_cols, cat_cols, ignore_col_list = set_columns(self.args.center)
        ...
        _, sig05_cols, sig10_AE_cols, self.AE_min_p, self.AE_max_auc = univariate_analysis(df[AE_cols + [label_str]], label_str,
                                                                                  sort_col='P_value',
        ...
        sig_clinic_cols = ['ECG_pre_QRSd', 'SPECT_pre_EDV']  # todo: check this
        ...
        if len(sig_AE_cols) > 0:
            ...
            if multi:
                ...
                feature_name_list = [
                    ...
                    'AE #{}'.format(sig_AE_cols[0].replace("AE_", "")),
                    'Clinic + PBW + AE #{}'.format(sig_AE_cols[0].replace("AE_", "")),
                    'Clinic + AE #{}'.format(sig_AE_cols[0].replace("AE_", "")),
                ]
                # sig_cols = ['ECG_pre_QRSd', 'Echo_pre_EDV']
                feature_list = [
                    sig_clinic_cols,
                    sig_clinic_cols + ['SPECT_pre_PBW'],
                    sig_clinic_cols + ['SPECT_pre_SRscore'],
                ...
                multivariate_analysis(df[sig05_cols + clinic_cols + [label_str]], feature_list, feature_name_list,
                                      ...
                                      y_axis='auc', line_list=[[0, 3], [1, 4], [2, 5]])
