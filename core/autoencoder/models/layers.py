# -*- coding: utf-8 -*-"
"""
Created on 05/27/2021  10:15 AM
...
class CNN_Encoder(nn.Module):
    def __init__(self, output_size, input_size=(1, 28, 28)):
        ...
        self.cov = nn.Sequential(
            nn.Conv2d(in_channels=1, out_channels=self.channel_size*1, kernel_size=4, stride=1, padding=1),
            nn.LeakyReLU(0.2, inplace=True),
            nn.Conv2d(self.channel_size*1, self.channel_size*2, 4, 2, 1),
            ...
            nn.LeakyReLU(0.2, inplace=True),
            nn.Conv2d(self.channel_size*8, self.channel_size*16, 3, 2, 1),
